...
import { Bounds, LatLng, LatLngBounds, Map, Point, Util, } from "leaflet";
describe("CanvasOverlay", () => {
    ...
    describe("params", () => {
        it("sets options", () => {
            ...
            const co = new CanvasOverlay(() => { }, "");
            co.params({ pane: "pane" });
            expect((_a = co.options) === null || _a === void 0 ? void 0 : _a.pane).toBe("pane");
        });
    });
    describe("redraw", () => {
    ...
    describe("_unclampedProject", () => {
        it("calls crs.transformation._transform with correct projectedPoint and scale", () => {
            ...
            map.options.crs.transformation, "_transform");
    ...
    describe("_unclampedLatLngBoundsToNewLayerBounds", () => {
        it("returns the correct unclamped value", () => {
            const co = getCo();
            expect(co._unclampedLatLngBoundsToNewLayerBounds(new LatLngBounds(new LatLng(1, 1), new LatLng(10, 10)), 10, new LatLng(5, 5))).toEqual(new Bounds(new Point(-2912.822222222225, -3673.0311028545693), new Point(3640.777777777781, 2917.7852501339657)));
        });
    });
});
function getCo(mapOptions) {
    const co = new CanvasOverlay(() => { }, "pane");
    const el = document.createElement("div");
