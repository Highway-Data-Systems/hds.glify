...
describe("glify", () => {
    ...
    describe("points", () => {
        ...
        beforeEach(() => {
            glify = new Glify();
            constructorSpy = jest.fn((settings) => { });
    ...
    describe("setupClick", () => {
        ...
        describe("when a click occurs", () => {
            ...
            let map;
            let element;
            let pointsTryClickSpy;
            let linesTryClickSpy;
            let shapesTryClickSpy;
            let latlng;
            let layerPoint;
            let containerPoint;
            beforeEach(() => {
    ...
    describe.skip("setupContextMenu", () => {
        ...
        describe("when a contextMenu occurs", () => {
            ...
            let map;
            let element;
            let pointsTryContextMenuSpy;
            let linesTryContextMenuSpy;
            let shapesTryContextMenuSpy;
            let latlng;
            let layerPoint;
            let containerPoint;
            beforeEach(() => {
    ...
    describe("setupHover", () => {
        ...
        describe("when a hover occurs", () => {
            ...
            let layerPoint;
            let containerPoint;
            let pointsTryHoverSpy;
            let linesTryHoverSpy;
            let shapesTryHoverSpy;
            beforeEach(() => {
                glify = new Glify();
                glify.Points = PointsSpy;
                glify.Lines = LinesSpy;
