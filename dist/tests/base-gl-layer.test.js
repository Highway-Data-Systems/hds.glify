import { BaseGlLayer, defaultHoverWait, defaultPane, } from "../base-gl-layer";
import { LatLng, LatLngBounds, Map, Point } from "leaflet";
describe("BaseGlLayer", () => {
    class TestLayer extends BaseGlLayer {
    ...
    describe("setupProgram", () => {
        ...
        it("calls gl.blendFunc with gl.SRC_ALPHA and gl.ONE_MINUS_SRC_ALPHA", () => {
            ...
            layer.setupProgram();
            expect(layer.gl.blendFuncSeparate).toHaveBeenCalledWith(layer.gl.SRC_ALPHA, layer.gl.ONE_MINUS_SRC_ALPHA, layer.gl.ONE, layer.gl.ONE_MINUS_SRC_ALPHA);
        });
