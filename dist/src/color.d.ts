...
export declare function hexToRgbNormalized(hex: string): IColor;
export declare function getChosenColor(chosenColor: string | IColor | [number, number, number] | [number, number, number, number]): IColor;
