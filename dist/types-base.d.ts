...
export type GlifyClickCallback<T = any> = (e: LeafletMouseEvent, feature: T, xy?: {
    x: number;
    y: number;
}) => boolean | void;
export type GlifyHoverCallback<T = any> = (e: LeafletMouseEvent, feature: T, xy?: {
    x: number;
    y: number;
}) => boolean | void;
export type GlifyHoverOffCallback<T = any> = (e: LeafletMouseEvent, feature: T) => boolean | void;
export type GlifyContextMenuCallback<T = any> = (e: LeafletMouseEvent, feature: T) => boolean | void;
